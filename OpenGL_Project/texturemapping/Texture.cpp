...
void Texture:: initTexture() {
	FIBITMAP* bitmap32 = createBitMap("snu.png");
...
void Texture:: drawSquareWithTexture() {
	...
	glBindTexture(GL_TEXTURE_2D, textureID);
	glBegin(GL_QUADS);
	glTexCoord2f(0.0f, 0.0f); glVertex2f(-WIDTH / 4.0f, -HEIGHT / 4.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex2f(-WIDTH / 4.0f, HEIGHT / 4.0f);
	glTexCoord2f(1.0f, 1.0f); glVertex2f(WIDTH / 4.0f, HEIGHT / 4.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex2f(WIDTH / 4.0f, -HEIGHT / 4.0f);
